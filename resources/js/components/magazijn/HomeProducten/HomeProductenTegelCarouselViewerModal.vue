...
const modalImages = computed(() => {
    ...
    const index = Math.max(0, Math.min(props.startIndex, props.images.length - 1));
...
<template>
    ...
    >
        <template #body>
            <div class="group relative h-[min(78vh,760px)] w-full overflow-hidden bg-magazijn-white">
                <UCarousel
